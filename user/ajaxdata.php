...
if (isset($_POST['pv_id'])) {
	...
	$sql = "SELECT * FROM `notes` WHERE mail='$mail' ORDER BY status ASC;";
...
} elseif (isset($_POST['pb_id'])) {


	$sql = "SELECT * FROM `notes` WHERE mail='$mail' ORDER BY status DESC;";
	$result = mysqli_query($Connector, $sql);
...
} elseif (isset($_POST['old_id'])) {


	$sql = "SELECT * FROM `notes` WHERE mail='$mail' ORDER BY time ASC;";
	$result = mysqli_query($Connector, $sql);
